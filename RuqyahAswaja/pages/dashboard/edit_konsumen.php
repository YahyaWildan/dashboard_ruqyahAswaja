<?php
  ...
  $id = $_GET['id'];
    $sql = mysqli_query($conn,"SELECT * FROM konsumen WHERE id=$id");
    while($konsumen_data=mysqli_fetch_array($sql)){
      $nama=$konsumen_data['nama'];
      $username =$konsumen_data['username'];
      $password = $konsumen_data['password'];
      ...
      <div class="main-content">
        <section class="section">
          ...
          <div class="section-body">
            <h2 class="section-title">Edit Konsumen</h2>
            <div class="row">
              <div class="col-12 col-md-12 col-lg-12">
              <form action="/RuqyahAswaja/backend/konsumen/editKonsumen.php?id=<?= $_GET['id'] ?>" method="post">                   
                <div class="card-body">
                ...
                <div class="card-footer text-right">
                  <a name="cancel" class="btn btn-danger text-white" href="index_konsumen.php">Cancel</a>
